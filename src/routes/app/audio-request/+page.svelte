...
<main>
    <article>
        ...
        <label id="upload" for="upload-audio" class="roundedbackground" on:dragover={e => e.preventDefault()} on:drop={event => onDropFiles(event)}>
        ...
        <input hidden type="file" multiple id="upload-audio" accept=".mp3,audio/*" on:change={populateAudios} />
    </article>
</main>
    ...
    main {
        ...
        #audios {
            ...
            #audio {
                ...
                border-radius: .5em;
                animation: left-to-right ease .5s;
                z-index: 1;
